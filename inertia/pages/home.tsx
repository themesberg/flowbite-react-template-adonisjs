  ...
  const CARDS = [
    {
      ...
      description: 'Learn more on how to get started and use the Flowbite React components',
    ...
    },
    {
      ...
      description: 'Get started with over 450 blocks to build websites even faster',
    ...
    },
    {
      ...
      description: 'Get started with over 650+ SVG free and open-source icons for your apps',
    ...
    },
    {
      ...
      description: 'Use our Figma Design System to design and collaborate better within your team',
        ...
        <div className="relative flex flex-col items-center gap-6">
          ...
          <span className="inline-flex flex-wrap items-center justify-center gap-2.5 text-center">
            ...
            <span className="relative inline-flex items-center gap-2">
              <img className="size-6" alt="Flowbite React logo" src="/flowbite-react.svg" />
              <span className="relative w-fit text-xl font-semibold whitespace-nowrap text-[#111928] dark:text-white">
                Flowbite React
              </span>
            </span>
            <h2 className="inline text-xl text-gray-600 dark:text-gray-400">now.</h2>
          </span>
        </div>
